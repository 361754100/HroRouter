 ...
 *
 */
public class BstLocationManager {
    ...
    private static BstLocationManager instance;
    ...
    public static BstLocationManager getInstance() {
        if (null == instance) {
            instance = new BstLocationManager();
        }
        return instance;
    }
